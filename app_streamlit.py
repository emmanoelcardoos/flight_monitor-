    ...
    if st.session_state.resultados_voos:
        ...
        with st.container(border=True):
            ...
            if col_al3.button("ATIVAR"):
                st.success("Avisaremos quando o teu voo chegar ao preço escolhido!")
...
# --- PÁGINA 2: RESERVA ---
    ...
    with st.form("form_final"):
        ...
        apelido = c2.text_input("Apelido") # Novo campo
        email = st.text_input("E-mail")

c3, c4 = st.columns(2)
dn = c3.date_input("Data de Nascimento", value=datetime(1995,1,1), max_value=datetime(2026,12,31))
documento = c4.text_input("CPF ou CC (Documento de Identidade)") # Novo campo
